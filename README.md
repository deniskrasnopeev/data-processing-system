...
The basic purpose of this program is to allow the user to manipulate their data by just writing mathematical functions with the program taking responsibility for checking for dependencies and running the functions in the right order.  
